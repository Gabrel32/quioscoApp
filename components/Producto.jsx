  ...
  return (
    <div className='border p-3'>
        ...
        <div className="p-5">
            ...
            <button type="botton" className="bg-pink-500 hover:bg-pink-800 w-full mt-1 text-white p-3 uppercase font-bold rounded-md" onClick={()=>setProducto(e)} >Agregar</button>
        </div>
